...
public class CheckLineAreEqualGreaterOrLess {   
	 ...
	 */
		public static void main(String[] args) 
	  {
		...
		System.out.printf("Length of First Line is : %.2f %n", lenghtOfLine1);       //calculate the length of first line.
		System.out.printf("Length of Second Line is : %.2f %n", lenghtOfLine2);       //calculate the length of second line.
	  
		int result  = lenghtOfLine1.compareTo(lenghtOfLine2);              //return 0 , <0 or >0
		if(result > 0)
		{
